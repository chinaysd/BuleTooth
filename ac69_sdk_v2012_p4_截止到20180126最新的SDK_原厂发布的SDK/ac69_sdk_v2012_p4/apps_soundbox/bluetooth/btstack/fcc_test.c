...
void test_fcc_default_info(void)
{
    ...
    __set_fcc_default_info(
                          ...
                          TRANSMIT_POWER,
                          HOP_MODE);
	//__set_ble_fcc_default_info();
}

//ble rf test 默认初始化配置
#define PACK_TYPE_PRBS9			0
#define PACK_TYPE_11110000		1
#define PACK_TYPE_10101010		2
#define PACK_TYPE_PRBS15		3
#define PACK_TYPE_11111111		4
#define PACK_TYPE_00000000		5
#define PACK_TYPE_00001111		6
#define PACK_TYPE_01010101		7

#define BLE_TRX_MODE			TX_MODE	
#define BLE_FRE_CHANNEL			0				//0-39	
#define BLE_PACKET_TYPE			PACK_TYPE_PRBS9
#define BLE_TX_POWER			9  		//0-9	
#define BLE_PACKET_LEN			0x20	//0x00-0xff

void test_ble_rf_default_info(void)
{
   	printf("%s \n",__FUNCTION__);
#if (BT_MODE == TEST_FCC_MODE) && (BLE_BREDR_MODE == BT_BLE_EN)
	puts("ble rf default test\n");
	__set_ble_rf_para_init(BLE_TRX_MODE,BLE_FRE_CHANNEL,BLE_PACKET_TYPE,BLE_PACKET_LEN,BLE_TX_POWER);
#endif
}
