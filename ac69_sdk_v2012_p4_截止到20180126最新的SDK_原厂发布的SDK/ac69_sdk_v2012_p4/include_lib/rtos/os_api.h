...
u8 OSTaskQAcceptNoClean(int argc, void *msg); 
#define os_taskq_accept_no_clean OSTaskQAcceptNoClean  

u8 OSTaskQPend (u16 timeout, int argc, void *msg);
#define os_taskq_pend OSTaskQPend

u8 OSTaskQPendNoClean(u16 timeout, int argc, void *msg);
#define os_taskq_pend_no_clean OSTaskQPendNoClean

u8 OSTaskQClean(u32 cleanMsg, u8 count);
#define os_taskq_msg_clean OSTaskQClean

u8 OSTaskQCheck(void);
#define os_taskq_msg_check OSTaskQCheck
