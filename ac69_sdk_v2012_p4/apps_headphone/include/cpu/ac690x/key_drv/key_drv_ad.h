...
#define ADC_PWR_VDDIO33         1
#define ADC_PWR_RTCVDD          2   //注意：使用RTCVDD这个宏的时候，默认还使用了PR1来协助做ADKEY，此时不能再用PR1口
#define ADC_PWR_RTCVDD_SIMPLE   3   //不借助PR1来做ADKEY，通过输出1来采集RTCVDD电压，用此模式时不能接0欧电阻的key

/*ADCKEY PWR SEL  1:vddio33  2 and 3:rtcvdd*/
#define ADC_PWR_SOURCE ADC_PWR_RTCVDD_SIMPLE
