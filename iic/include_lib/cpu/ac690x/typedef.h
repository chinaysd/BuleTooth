...
#define  MAKEWORD(H,L)        ((u16)(L) | ((u16)(H) << 8))
#define  UintToByte3(data)    ((u8 *)(&data))[0]/*¡Á?¦Ì¨ª¡Á??¨²*/
#define  UintToByte2(data)    ((u8 *)(&data))[1]
#define  UintToByte1(data)    ((u8 *)(&data))[2]
#define  UintToByte0(data)    ((u8 *)(&data))[3]
...
#define  DATA_Y_MIRROR(Uc_Data) (((Uc_Data&BIT(7))<<0))|(((Uc_Data&BIT(6))<<0))|((Uc_Data&BIT(5))>>3)|((Uc_Data&BIT(4))>>3)|((Uc_Data&BIT(3))>>3)|((Uc_Data&BIT(2))<<3)|((Uc_Data&BIT(1))<<3)|(((Uc_Data&BIT(0))<<3))
