...
typedef enum
{
    ...
    BT_STATUS_PHONE_OUT        ,/*打出电话A*/
    BT_STATUS_PHONE_ACTIVE     ,/*接通电话B*/
    BT_STATUS_PHONE_HANGUP     ,/*挂断电话C*/
    BT_STATUS_BEGIN_AUTO_CON   ,/*发起回连D*/
    BT_STATUS_MUSIC_SOUND_COME ,/*库中加入auto mute判断音乐播放开始E*/
    BT_STATUS_MUSIC_SOUND_GO   ,/*库中加入auto mute判断音乐播放暂停F*/
    BT_STATUS_RESUME           ,/*后台有效，手动切回蓝牙10*/
    BT_STATUS_RESUME_BTSTACK   ,/*后台有效，后台时来电切回蓝牙11*/
    BT_STATUS_SUSPEND          ,/*蓝牙挂起，退出蓝牙12*/
    BT_STATUS_TONE_BY_FILE_NAME ,/*直接使用文件名播放提示音13*/

   /*下面是1个持续的状态，是get_stereo_bt_connect_status获取*/
    BT_STATUS_STEREO_WAITING_CONN,/*page连接对箱中，还没连接上14*/

   /*下面是6个持续的状态，是get_bt_connect_status()获取*/
    BT_STATUS_INITING          ,/*正在初始化15*/
    BT_STATUS_WAITINT_CONN     ,/*等待连接16*/
    BT_STATUS_AUTO_CONNECTINT  ,/*正在回连17*/
    BT_STATUS_CONNECTING       ,/*已连接，没有电话和音乐在活动18*/
    BT_STATUS_TAKEING_PHONE    ,/*正在电话19*/
    BT_STATUS_PLAYING_MUSIC    ,/*正在音乐1A*/
}STATUS_FOR_USER;
